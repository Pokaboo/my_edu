  ...
  <div class="app-container">
    ...
    <el-form :inline="true" class="demo-form-inline">
      ...
      <el-form-item label="课程类别">
        ...
        >
          <el-option
            v-for="subjectSub in subSubjectList"
            :key="subjectSub.id"
            :label="subjectSub.title"
            :value="subjectSub.id"
          />
        </el-select>
      </el-form-item>
    ...
    >
      ...
      <el-table-column label="操作" width="150" align="center">
        <template slot-scope="scope">
          ...
          <el-button type="text" size="mini" icon="el-icon-delete"  @click="removeDataById(scope.row.id)"
            >删除</el-button
          >
        </template>
      </el-table-column>
...
export default {
  ...
  methods: {
    ...
    initTeacherList() {
      course.findAllEduTeacher().then(response => {
